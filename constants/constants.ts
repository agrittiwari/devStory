...
//Enquiry
export const LAST_VISIT_DATE_CANNOT_BE_FUTURE_DATE =
  'Last visit date cannot be future date'
export const NEXT_FOLLOWUP_CANNOT_BE_PREVIOUS_DATE =
  'Next followup cannot be previous date'

export const ENQUIRY_DATE_CANNOT_BE_FUTURE_DATE =
  'Enquiry date cannot be future date'
